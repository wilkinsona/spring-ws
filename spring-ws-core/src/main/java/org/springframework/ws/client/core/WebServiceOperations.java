...
public interface WebServiceOperations {
	 ...
	 * message
	 */
	@Nullable <T> T sendAndReceive(String uri, WebServiceMessageCallback requestCallback,
			WebServiceMessageExtractor<T> responseExtractor) throws WebServiceClientException;
	 ...
	 * message
	 */
	@Nullable <T> T sendSourceAndReceive(Source requestPayload, SourceExtractor<T> responseExtractor)
			throws WebServiceClientException;
	 ...
	 * message
	 */
	@Nullable <T> T sendSourceAndReceive(String uri, Source requestPayload, SourceExtractor<T> responseExtractor)
			throws WebServiceClientException;
	 ...
	 * message
	 */
	@Nullable <T> T sendSourceAndReceive(Source requestPayload, WebServiceMessageCallback requestCallback,
	 ...
	 * message
	 */
	@Nullable <T> T sendSourceAndReceive(String uri, Source requestPayload, @Nullable WebServiceMessageCallback requestCallback,
			SourceExtractor<T> responseExtractor) throws WebServiceClientException;
